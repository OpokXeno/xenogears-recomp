...
typedef enum XgRenderRuntimeVariantCutoverTransfer {
    XG_RENDER_RUNTIME_VARIANT_TRANSFER_OBSERVE = 0,
    XG_RENDER_RUNTIME_VARIANT_TRANSFER_LOCAL,
    XG_RENDER_RUNTIME_VARIANT_TRANSFER_RETURN,
    XG_RENDER_RUNTIME_VARIANT_TRANSFER_OBSERVE_AFTER,
} XgRenderRuntimeVariantCutoverTransfer;
