...
function(assert_invalid_fixture archive platform case_name)
    ...
    elseif(case_name STREQUAL "unexpected-mod-asset")
        set(_unexpected_path
            "mods/bundled/psx.enhancement.fast-loading/1.0.0/assets/unexpected.bin")
    ...
    elseif(case_name STREQUAL "obsolete-overlay-toolchain")
        set(_unexpected_path "overlay_toolchain/compile_overlays.py")
    else()
...
function(create_invalid_archive platform case_name output_variable)
    ...
    elseif(case_name STREQUAL "missing-cd-speed-manifest")
        file(REMOVE "${_package_root}/mods/bundled/${CD_SPEED_MANIFEST}")
    elseif(case_name STREQUAL "missing-fast-loading-manifest")
        file(REMOVE "${_package_root}/mods/bundled/${FAST_LOADING_MANIFEST}")
    elseif(case_name STREQUAL "missing-pgxp-manifest")
        file(REMOVE "${_package_root}/mods/bundled/${PGXP_MANIFEST}")
    elseif(case_name STREQUAL "modified-builtin-manifest")
        file(APPEND "${_package_root}/mods/bundled/${FAST_LOADING_MANIFEST}"
